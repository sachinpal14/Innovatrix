...
export default function MedicineOrderForm({ medicine, onClose }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 relative to-purple-50 p-4 mt-10 sm:p-6 lg:p-8">
      <button 
      onClick={onClose}
      className='text-2xl absolute top-50 right-10 '> <RxCross1/> </button>
        ...
        {orderSuccess && (
          <div className="mb-6 bg-green-50 border-2 border-green-500 rounded-xl p-4 flex items-center gap-3 animate-pulse">
            ...
            <div>
              ...
              <p className="text-sm text-green-700">Your order for {quantity} units has been confirmed.</p>
            </div>
          </div>
        )}
